...
const (
	OdhConfigMapName             = "odh-trusted-ca-bundle"    // ODH Trusted CA Bundle: ca-bundle.crt, odh-ca-bundle.crt
	...
	CaBundleCertMountPath        = "/etc/pki/tls/custom-certs/ca-bundle.crt"
	trueString                   = "true"
)
